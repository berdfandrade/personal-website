import { Grid, Flex, Progress, Icon, Text, Center } from "@chakra-ui/react";
...
function HabilidadesGit() {
  return (
    <Flex direction="column" align="center" mt={4}>
      ...
      >
        <IconHabilidade
          icone={DI.DiGitCommit}
          nome={"Commits"}
          progresso={85}
        />
        <IconHabilidade
          icone={RI.RiGitRepositoryCommitsFill}
          nome={"Repositories"}
          progresso={100}
        />
  ...
  return (
    <Flex direction="column" align="center" mt={4}>
      ...
      >
        ...
        <IconHabilidade
          icone={FA.FaRobot}
          nome={<Text textAlign={"left"}>Structs</Text>}
          progresso={30}
        />
      </Grid>
    </Flex>
